...
export default function BoardInput({ setAddingWords, setBoard }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Button style={[styles.button, {backgroundColor: 'green', marginTop: 20}]} onPress={() => generateBoard()}>Generate GameBoard</Button>
      <Button style={[styles.button, {backgroundColor: 'red'}]} onPress={() => setAddingWords(false)}>Back to Home Page</Button>
